...
public:
    ...
    static JS::NonnullGCPtr<ClassicScript> create(DeprecatedString filename, StringView source, EnvironmentSettingsObject&, AK::URL base_url, ScriptFetchOptions, size_t source_line_number = 1, MutedErrors = MutedErrors::No);
...
private:
    ClassicScript(AK::URL base_url, DeprecatedString filename, EnvironmentSettingsObject& environment_settings_object, ScriptFetchOptions);
