...
void fetch_external_module_script_graph(AK::URL const&, EnvironmentSettingsObject& settings_object, Function<void(JavaScriptModuleScript const*)> callback);
...
void fetch_single_module_script(AK::URL const&, EnvironmentSettingsObject& fetch_client_settings_object, StringView destination, EnvironmentSettingsObject& module_map_settings_object, AK::URL const& referrer, Optional<JS::ModuleRequest> const&, Function<void(JavaScriptModuleScript const*)> callback);
