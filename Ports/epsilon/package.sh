...
auth_type=sha256
makeopts=("PLATFORM=simulator" "TARGET=serenity" "GELASSENHEIT_INSTALL_ROOT=${GELASSENHEIT_INSTALL_ROOT}")
...
install() {
    run cp output/release/simulator/serenity/epsilon.elf ${GELASSENHEIT_INSTALL_ROOT}/usr/local/bin/
}
