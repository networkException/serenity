...
```console
Meta/gelassenheit.sh rebuild-toolchain
```
...
`Meta/gelassenheit.sh build`. The `serenity.sh` script also provides a number of other commands. Run the script without
